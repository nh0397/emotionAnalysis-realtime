% DRAFT VERSION - Fast compilation for Overleaf
% Copy this content to main.tex for faster compilation
...
onehalfspacing,
headsepline,
draft,  % <-- This enables draft mode (skips images)
...
\supervisor{Dr. Shahrukh Humayoun \& Dr. Jingy Wang}
\examiner{}
...
\href{}{\textcolor{SFSUPurple}{Dr. Jingy Wang}}
\end{flushleft}
...
Social media has matured into a shared record of how communities experience the world in real time. Posts arrive with timestamps, locations, and emotions attached, creating a living archive of public mood. Yet the pace of these conversations outstrips traditional reporting cycles, leaving decision makers to react after sentiment has already shifted. This thesis starts from that tension: the data is available, but insight often arrives too late.
...
% Comment out appendices for faster compilation
% Uncomment for final version
% \appendix
% \include{Chapters/Appendices/AppendixA_Model_Evaluation}
% \include{Chapters/Appendices/AppendixB_System_Architecture}
% \include{Chapters/Appendices/AppendixC_User_Interface_Design}
